...
impl ErrorData {
    ...
    pub fn std(code: i32) -> Self {
        match code {
            ...
            // errors. Any code within this range, but not defined explicitly below is
...
pub struct Request {
    ...
    /// that begin with the word rpc followed by a period character (U+002E
    /// or ASCII 46) are reserved for rpc-internal methods and extensions and
