            ...
            Some(ref topics) => bs
                ...
                .flat_map(|bloom| {
                    topics
                        ...
                        .map(|topic| {
                            let mut b = bloom;
                            b.accrue(BloomInput::Hash(topic.as_fixed_bytes()));
                            b
                        })
                        .collect::<Vec<Bloom>>()
                })
...
mod tests {
    ...
    fn test_bloom_possibilities_none() {
        ...
        assert_eq!(possibilities[0], Bloom::default());
    }
    ...
    fn test_bloom_possibilities_single_address_and_topic() {
        ...
        let blooms: Vec<Bloom> = vec![Bloom::from_str(
            "
             00000040000000000000000000000000000000000000000000",
        )
        .unwrap()];
        ...
        let blooms: Vec<Bloom> = vec![
            Bloom::from_str(
                "00000000000000000000000000000000001000000000000000000000000000
                 ...
                 
                 0000000000000000",
            )
            .unwrap(),
            Bloom::from_str(
