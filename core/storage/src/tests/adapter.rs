...
//     adapter_insert_test(RocksAdapter::new("rocksdb/test_adapter_insert".
// to_string(), 64).unwrap()) }
//
// #[test]
...
//         RocksAdapter::new("rocksdb/test_adapter_batch_modify".to_string(),
// 64).unwrap(),     )
// }
//
// #[test]
...
//     adapter_remove_test(RocksAdapter::new("rocksdb/test_adapter_remove".
// to_string(), 64).unwrap()) }
//
