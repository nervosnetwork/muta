...
// use common_crypto::{
//    Crypto, PrivateKey, PublicKey, Secp256k1, Secp256k1PrivateKey, Signature,
// ToPublicKey,
//};
...
// use protocol::types::{
//    Address, Block, Hash, Hex, Proof, Receipt, ServiceContext,
...
//        .unwrap();
//
//    let sig = Secp256k1::sign_message(&hash.as_bytes(),
// &priv_key.to_bytes()).unwrap();    let mut input_sig: String =
// "0x".to_string();    input_sig.push_str(hex::encode(sig.to_bytes()).
// as_str());    let sig_data = Hex::from_string(input_sig).unwrap();
//
//    println!(
//        "pubkey: {}\r\nsig: {}",
...
//    async fn insert_transactions(&self, _: Vec<SignedTransaction>) ->
// ProtocolResult<()> {        unimplemented!()
//    }
//
...
//    }
//
//    async fn get_transaction_by_hash(&self, _: Hash) ->
// ProtocolResult<SignedTransaction> {        unimplemented!()
//    }
//
//    async fn get_transactions(&self, _: Vec<Hash>) ->
// ProtocolResult<Vec<SignedTransaction>> {        unimplemented!()
//    }
//
